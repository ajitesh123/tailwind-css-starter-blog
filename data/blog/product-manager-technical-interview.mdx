...
<div className="mb-4 border-l-4 border-blue-500 bg-gray-100 p-4 dark:bg-gray-800">
  <h4 className="mb-2 text-lg font-bold text-gray-900 dark:text-gray-100">Remember:</h4>
...
<div className="relative aspect-video w-full">
  <iframe
    ...
    src="https://www.youtube.com/embed/bpuWAMbxM2A"
...
<div className="my-8 flex justify-center">
  <a
    href="https://pm-interview-prep1.teachable.com/"
    className="rounded-lg bg-primary-500 px-20 py-4 text-lg"
    target="_blank"
    rel="noopener noreferrer"
  >
    <span className="text-white">Get the Full Course →</span>
  </a>
</div>
