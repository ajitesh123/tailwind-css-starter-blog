...
This is the most important file. It is used to configure pytest. It is used to tell pytest where to find the tests, what to test and how to test.

We learned about it a bit late, and that created a lot of issues. This files offers a lot of flexibility. For exapple, eventhough our files don;t started with `test_`, pysted worked as used wildcard for python files below.
