...
It's easier to build product when you've clear guiding force. To that end, I've formed adopted some principles over the years.
...
## 7. Optimist What We're Building, Pessimist About What We've Built

Macro-optimistic, micro-pessimistic: Optimistic about how the product will work in the long run, but really impatient with the current state. We keep challenging the status quo and making progress for our users.
